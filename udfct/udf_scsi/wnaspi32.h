...
#define SS_INSUFFICIENT_RESOURCES   0xE9        // Couldn't allocate resources needed to
                                                // init
#define SS_ASPI_IS_SHUTDOWN         0xEA        // Call came to ASPI after PROCESS_DETACH
#define SS_BAD_INSTALL              0xEB        // The DLL or other components are
                                                // installed wrong
...
#define HASTAT_TIMEOUT              0x09        // Timed out while SRB was waiting to
                                                // be processed.
#define HASTAT_COMMAND_TIMEOUT      0x0B        // Adapter timed out processing SRB.
#define HASTAT_MESSAGE_REJECT       0x0D        // While processing SRB, the adapter
                                                // received a MESSAGE
